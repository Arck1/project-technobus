...
$(function googleApi() {
    ...
    var tableViewer = new TableViewer("#scheduleList", ".info-list");
...
$(function () {
    ...
    function setDate() {
        ...
        var listFromm = $("#scheduleList1").get(0).children;
        var ctime = void 0;
        var chm = 90000;
        var time = new Date();
        ...
        for (var i = 0; i < listTo.length; i++) {
            var li = listTo[i];
            var divTime = li.children[0];
            var divInfo = li.children[1];

            var _divTime$innerText$sp = divTime.innerText.split(':'),
                _divTime$innerText$sp2 = _slicedToArray(_divTime$innerText$sp, 2),
                h = _divTime$innerText$sp2[0],
                m = _divTime$innerText$sp2[1];
