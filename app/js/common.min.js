...
$(function () {
    ...
    function setDate() {
        ...
        if (minDiffFromTime >= 1) {
            selected_item.className = "bstop";
            $(".bstop").after("<li class=\"break fone\"><div class=\"time-info\">" + "<div class=\"info\">Перерыв " + minDiffFromTime + " минут</div>" + "<div class=\"desc\">Воспользуйтесь общественным транспортом</div></div></li>");
        } else {
            $(".break fone").remove();
        }
        ...
        if (index < listTo.length - 1) {
            var nextTime = listTo[index + 1].children[0];
        ...
        if (minDiffFromTime >= 40) {
            selected_item.className = "bstop";
            $(".bstop").after("<li class=\"break ftwo\"><div class=\"time-info\">" + "<div class=\"info\">Перерыв " + minDiffFromTime + " минут</div>" + "<div class=\"desc\">Воспользуйтесь общественным транспортом</div></div></li>");
        ...
        if (index < listFrom.length - 1) {
            var _nextTime = listFrom[index + 1].children[0];
